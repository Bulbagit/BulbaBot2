    ...
    async execute(message) {
        ...
        if (linkRegex.test(message.content.toLowerCase())) {
            ...
            try {
                ...
                console.error(error);
                return message.reply("An error occurred while fetching data. Make sure you spelled the search correctly, or if the page really exists. If you believe this is an error, please report on <#370291387050098689>.");
            }
        }
